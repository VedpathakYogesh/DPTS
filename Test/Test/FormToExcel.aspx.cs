...
namespace Test
{
    public partial class FormToExcel : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //making query    
            string query = "INSERT INTO [Sheet1] ([FirstName], [LastName], [Address], [City], [State],[zip],[IsActive] ) VALUES('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox7.Text + "','" + TextBox6.Text + "','" + TextBox8.Text + "')";
